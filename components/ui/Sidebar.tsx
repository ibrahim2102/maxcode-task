      ...
      >
        <div className="flex items-center justify-between border-b border-black/10 px-5 py-4 dark:border-white/10">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-black/10 px-3 py-1.5 text-sm text-zinc-900 hover:bg-black/[.03] dark:border-white/10 dark:text-zinc-50 dark:hover:bg-white/[.06]"
          >
            Close
          </button>
        </div>
        ...
        <div className="flex h-[calc(100dvh-65px)] flex-col gap-6 overflow-auto p-5">
          ...
          <div className="mt-auto flex items-center justify-between gap-3 pt-2">
            ...
            <div className="text-xs text-zinc-500 dark:text-zinc-400">Tip: press Esc</div>
          </div>
        </div>
      </aside>
    </>
